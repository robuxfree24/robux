...
$( document ).ready( function() {
    ...
    function newActivity() {
        ...
        var platforms = [ '<i class="fab fa-android orange_color"></i>', '<i class="fab fa-apple orange_color"></i>' ];
        ...
        $( '.activityContent' ).hide().prepend('<div class="activity">' +
           '<ul>' +
                ...
                '<li><span>ROBUX</span><br /><img class="item-icon" src="img/bp.png"> <b>'+battlepointsRand+'</b></li>' +
    ...
    $( '.btnVerify' ).click( function() {
        ...
        $( '.generator_page_3' ).fadeOut( function() {
            ...
            $( '.generatorTxt' ).html( 'Robux <span class="orange_color"><img class="item-icon" src="img/bp.png"> </span><span class="orange_color bpJS">10</span>' );
